...
Заходим на кластер 16 версии  
Создаем пустую БД и схему в ней заранее.  
Пробуем восстановиться, но ничего не вижу. В БД нет данной таблицы или не видна.  
![image](https://github.com/13-rus/Otus/assets/120638894/dd33070c-3b2e-4f3e-98b1-b72a7268e88b)

оказалось дело было в опечатке)  
Создал схему заново в новой бд  
...
Все получилось. Проблема была, что я восстанавливал изначально таблицу test2, а она была t_test2.  
Соответственно такой не было и ничего не восстанавливалось.
